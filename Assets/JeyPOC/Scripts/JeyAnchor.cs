...
public class JeyAnchor : MonoBehaviour
{
    public string myType = "";

    public const string NumUuidsPlayerPref = "numUuids";

    [SerializeField, FormerlySerializedAs("visual_")]
    ...
    private void Update()
    {
        ...
        BillboardPanel(_canvas.transform); //lookat


        // Billboard the menu
        //BillboardPanel(_pivot); //lookat
    ...
    void SaveUuidToPlayerPrefs(Guid uuid)
    {
        ...
        //by SR
        PlayerPrefs.SetString(uuid.ToString(), myType);
    }
    ...
    {
        _anchorMenu.SetActive(!_anchorMenu.activeSelf);
    }
